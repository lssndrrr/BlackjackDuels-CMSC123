...
void game::renderDeck(){
    const float cardWidth = tempCard.getGlobalBounds().width;
    const float cardHeight = tempCard.getGlobalBounds().height;

    const float spacing = tempCard.getGlobalBounds().width + 5.f;
